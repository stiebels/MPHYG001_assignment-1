...
def runModule():
    ...
    parser.add_argument('-o', dest='path', help='If specified, graph is saved to location specified by the path, e.g. \'/home/user/graph.png\'. Otherwise, graph is only displayed but not auto-saved', required=False)
